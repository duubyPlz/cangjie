...
var _default = new _plugin.Packager({
  async package({
    ...
    var _mainEntry$publicId, _mainEntry2;
    ...
    bundle.traverse(node => {
      ...
      if (node.type === 'asset') {
        ...
        let output = code || '';
        wrapped += JSON.stringify(asset.publicId) + ':[function(require,module,exports) {\n' + output + '\n},';
    ...
    return replaceReferences({
      contents: prefix + '({' + assets + '},{},' + JSON.stringify(entries.map(asset => asset.publicId)) + ', ' + JSON.stringify((_mainEntry$publicId = (_mainEntry2 = mainEntry) === null || _mainEntry2 === void 0 ? void 0 : _mainEntry2.publicId) !== null && _mainEntry$publicId !== void 0 ? _mainEntry$publicId : null) + ', ' + 'null' + ')' + '\n\n' + (await getSourceMapSuffix(getSourceMapReference, map)),
      map
    });
  }
